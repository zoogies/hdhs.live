        ...
        for (p in content){
            ...
            if(deleted_status == 0){ 
                ...
                if(post_content != ''){
                    ...
                    header = '<div class="post" id="'+post_id+'"><div class="p_header"><img class="icon" src="https://hdhs.live/static/resources/user.png"/><p class="uname">'+post_user+'</p><p class="ID">'+'#'+post_id+'</p><p class="ID stamp">'+stamp+'</p></div><p class="spaced">'+finalcontent+'</p>'
                }
                else{
                    header = '<div class="post" id="'+post_id+'"><div class="p_header"><img class="icon" src="https://hdhs.live/static/resources/user.png"/><p class="uname">'+post_user+'</p><p class="ID">'+'#'+post_id+'</p><p class="ID stamp">'+stamp+'</p></div>'
                }
                ...
                if (attachment_id != null){
                    ...
                    try{
                        ...
                        path = 'https://hdhs.live/static/attachments/'+attachment_table[attachment_id][2]
                        //console.log(path)
                    }
                    catch{
                        var attachmentExtension = 'png'
                        path = 'https://hdhs.live/static/resources/error.png'
                    }

                    //if its an allowed video
                    if(videotypes.includes(attachmentExtension)){
                        //document.getElementById(post_id).innerHTML+='<div class="embed"><img class="attachment" src="'+'https://hdhs.live/static/attachments/'+attachment_table[attachment_id][2]+'"/></div>'
                        document.getElementById(post_id).insertAdjacentHTML('beforeend','<div class="embed"><video preload="none" poster="https://hdhs.live/static/attachments/previews/'+attachment_id +'.jpg" class="attachment" controls><source src="'+path+'"></video></div>');
                    }
...
function renderComments(id,data){
    ...
    for(comment in data){
        ...
        var comlaughbtn = '<div onclick="laugh(\'' +data[comment][0]+ '\',\'' + 'comment'+ '\')" class="comlaughbtn"><p>Laugh</p><img class="joy" src="https://hdhs.live/static/resources/joy.png"/></div>'
...
function refreshcomments(post){
    ...
    if (!handler.classList.contains('opened')){
        ...
        //document.getElementById(post).innerHTML += '<img id="comloadgif" src="https://hdhs.live/static/resources/load.gif"/>';
